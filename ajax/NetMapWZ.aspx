<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NetMapWZ.aspx.cs" Inherits="direct_demo.ajax.NetMapWZ" %>
            ...
            <div class="ms-info">
                ...
                <table class="menu" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td style="text-align:left;">显示层数:
                        <%
                            string url = "netMapWZ.aspx?r=1";
                ...
                <%
                                if (_preBianhao != "")
                                {
                                    Response.Write("<p style=\" text-align:center;\"><a class=\"cursor\" onclick=\"location.href='netMapWZ.aspx?bianhao=" + _preBianhao + "'\">上一层</a></p>");
                                } 
                    %>
