<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="netMap_team_mobile.aspx.cs" Inherits="direct_demo.ajax.netMap_team_mobile" %>
                ...
                <table class="menu" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td width="180" style="text-align:left;">
                            ...
                            <input id="Button1" type="button" class="m-btn m-btn-blue" value="返回顶层" onclick="window.location.href='netmapwz.aspx'" style="width:80px;" />
                        </td>
                        <td>&nbsp;</td>
                    </tr>
                </table>
                <div> <a href="netmap_team_jd.aspx?teamtype=3">切换树形图</a>  (注：点击会员编号查看下一层)</div>
                <%
                                if (_preBianhao != "")
                                {
                                    Response.Write("<p style=\" text-align:center;\"><a class=\"cursor\" onclick=\"location.href='netMap_team_mobile.aspx?teamtype="+teamType+"&bianhao=" + _preBianhao + "'\">上一层</a></p>");
                                } 
                    %>
...
<script type="text/javascript">
    var pck = {
        ...
        search: function () {
            ...
            if (val1 != "")
                window.location.href = "netmapwz.aspx?bianhao=" + val1;
        },
        init: function () {
