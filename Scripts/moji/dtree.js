...
function dTree(objName) {
	...
	this.icon = {
		root				: '../../Scripts/moji/img/base.gif',
		folder: '../../Scripts/moji/img/folder.gif',
		folderOpen: '../../Scripts/moji/img/folderopen.gif',
		node: '../../Scripts/moji/img/page.gif',
		empty: '../../Scripts/moji/img/empty.gif',
		line: '../../Scripts/moji/img/line.gif',
		join: '../../Scripts/moji/img/join.gif',
		joinBottom: '../../Scripts/moji/img/joinbottom.gif',
		plus: '../../Scripts/moji/img/plus.gif',
		plusBottom: '../../Scripts/moji/img/plusbottom.gif',
		minus: '../../Scripts/moji/img/minus.gif',
		minusBottom: '../../Scripts/moji/img/minusbottom.gif',
		nlPlus: '../../Scripts/moji/img/nolines_plus.gif',
		nlMinus: '../../Scripts/moji/img/nolines_minus.gif'

//      root				: '../moji/img/base.gif',
//		folder			: '../moji/img/folder.gif',
//		folderOpen	: '../moji/img/folderopen.gif',
//		node				: '../moji/img/page.gif',
//		empty				: '../moji/img/empty.gif',
//		line				: '../moji/img/line.gif',
//		join				: '../moji/img/join.gif',
//		joinBottom	: '../moji/img/joinbottom.gif',
//		plus				: '../moji/img/plus.gif',
//		plusBottom	: '../moji/img/plusbottom.gif',
//		minus				: '../moji/img/minus.gif',
//		minusBottom	: '../moji/img/minusbottom.gif',
//		nlPlus			: '../moji/img/nolines_plus.gif',
//		nlMinus			: '../moji/img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
...
function opena()
{          if (this.aNodes[1]._hc && this.aNodes[1].pid != this.root.id) {
			this.nodeStatus(true, 1, this.aNodes[1]._ls)
			this.aNodes[1]._io = true;
			}
}
