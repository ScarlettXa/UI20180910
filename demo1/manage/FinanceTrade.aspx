<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FinanceTrade.aspx.cs" Inherits="direct_demo.demo1.manage.FinanceTrade" %>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[财务管理]-[理财列表]</td>
              </tr>
            </table></td>
...
<asp:Repeater ID="rptlist" runat="server">
  <ItemTemplate>
          <tr>
            ...
            <td><%#float.Parse(Eval("days").ToString()).ToString()%></td>
            <td><%#Eval("addTime").ToString()%></td>
            <td><%#Eval("days2").ToString()%></td>
            <td><%#float.Parse(Eval("m2").ToString()).ToString("0.##")%></td>
            <td>
               <%#Eval("invalid").ToString()=="0"?"正常":"<span style=\"color:#666;\">已结束</span>"%>
            </td>
          </tr>
  </ItemTemplate>
</asp:Repeater>
