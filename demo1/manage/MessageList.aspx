<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MessageList.aspx.cs" Inherits="direct_demo.demo1.manage.MessageList" %>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[站内短信]-[<asp:Literal ID="txtTitle" runat="server"></asp:Literal>]</td>
              </tr>
            </table></td>
      ...
      <tr>
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()" class="list1_tb">
          <tr>
            ...
            <th>序号</th>
            <th><asp:Literal ID="txtAct" runat="server"></asp:Literal></th>
            <th>内容</th>
            <th>时间</th>
            <th>操作</th>
          </tr>
<asp:Repeater ID="rptlist" runat="server">
   <ItemTemplate>
          <tr>
            ...
            <td><%#_lb == 1 ? Eval("MFrom").ToString() : Eval("MTo").ToString()%></td>
            <td><%#Eval("MContent") %></td>
            <td><%#Eval("MAddTime") %></td>
            <td>
                <%--<asp:HyperLink ID="HyperLink1" NavigateUrl='<%#"messageview.aspx?id="+Eval("MId") %>' runat="server">查看</asp:HyperLink>--%>
                <span style="display:<%=answerBtn %>">  <asp:HyperLink ID="HyperLink2" NavigateUrl='<%#"messageAdd.aspx?id="+Eval("MId") %>' runat="server">回复</asp:HyperLink></span>  
