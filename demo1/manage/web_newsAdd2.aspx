<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="web_newsAdd2.aspx.cs" Inherits="direct_demo.demo1.manage.web_newsAdd2" ValidateRequest="false" %>
                        ...
                        <tbody>
                            <tr>
                                <td background="/demo1/images/corp_main_table_abj.gif" height="23" align="center">
                                    &nbsp;<strong><asp:Literal ID="txtInfo1" runat="server" Text="添加"></asp:Literal> </strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
