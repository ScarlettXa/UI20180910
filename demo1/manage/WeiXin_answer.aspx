<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WeiXin_answer.aspx.cs" Inherits="direct_demo.demo1.manage.WeiXin_answer" %>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[数据管理]-[微信回复]</td>
              </tr>
            </table></td>
...
<asp:Repeater ID="rptlist" runat="server">
  <ItemTemplate>
          <tr>
            ...
            <td>
             <asp:HyperLink ID="HyperLink2" NavigateUrl='<%#"WeiXin_answerAdd.aspx?id="+Eval("id") %>' runat="server">修改</asp:HyperLink> &nbsp; 
