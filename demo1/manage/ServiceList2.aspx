<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ServiceList2.aspx.cs" Inherits="direct_demo.demo1.manage.ServiceList2" %>
  ...
  <TD height="20" align="left" bgColor="#d4e8fa" ><table width="100%" border="0" cellpadding="3" cellspacing="1">
	<TR>
	  ...
	  <TD height="38" align="left" valign="middle" bgColor="#FBFDFF" >
	      ...
	      <asp:TextBox ID="endTime" runat="server" onfocus="calendar()" Style="width: 80px;"></asp:TextBox>
	  ...
	  <TD align="right" valign="middle" bgColor="#FBFDFF" >
         ...
         <TD align="right" valign="middle" bgColor="#FBFDFF" width="50%">&nbsp;&nbsp; </TD>   
	  </TR>
          ...
          <tr>
            <td width="46%" valign="middle"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="95%" class="STYLE1"><span class="STYLE3">你当前的位置</span>：[服务中心]-[已开通服务中心]</td>
              </tr>
            </table></td>
...
<asp:Repeater ID="rptlist" runat="server">
  <ItemTemplate>
          <tr>
            ...
            <td>
                <%#Eval("huiyuan_bianhao").ToString() %></a>
            ...
            <td><%#Eval("huiyuan_zm_mingcheng")%></span></td>
            <td><%#getcol("tbl_canshu2", "canshu3_name", " and id=" + Eval("zhuanmai_jb").ToString())%></td>
            <td><%#Eval("huiyuan_zm_qr_date").ToString()%></td>
            <td>
               <asp:LinkButton ID="LinkButton1" runat="server" OnCommand="Operate_Command" CommandName="zmd_cancel" CommandArgument='<%#Eval("huiyuan_bianhao") %>'  OnClientClick="return ifConfirm()">取消</asp:LinkButton>
